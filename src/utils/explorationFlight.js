...
export const RETURN_FLIGHT_DURATION_SECONDS = 2.8;
export const BIRD_LEAD_OFFSET = 0.18;
export const FLIGHT_ARC_HEIGHT = 4;
export const RETURN_FLIGHT_ARC_HEIGHT = 3.2;
export const CAMERA_FOLLOW_BEHIND = 10;
export const CAMERA_FOLLOW_ABOVE = 4;
export const CAMERA_FOLLOW_DAMPING = 4;
export const CAMERA_RETURN_FOLLOW_BEHIND = 5.5;
export const CAMERA_RETURN_FOLLOW_ABOVE = 2.6;
export const CAMERA_RETURN_FOLLOW_DAMPING = 7.5;
export const CAMERA_SETTLE_DAMPING = 2.4;
export const CAMERA_LOOK_AT_DAMPING = 3.2;
